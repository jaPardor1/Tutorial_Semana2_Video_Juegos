import esper
from src.create.prefab_creator import create_enemy_hunter, create_enemy_square, create_square
from src.ecs.components.c_enemy_spawner import CEnemySpawner, SpawnEventData

def system_enemy_spawner(world:esper,enemies_data:dict,delta_time:float):
